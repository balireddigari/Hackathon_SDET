...
public class HomeLoan extends DriverSetup {
	...
	public void loan_amount() throws InterruptedException, IOException {
		...
		// Locating the Loan amount element
		...
		// Entering Loan Amount from properties file
	...
	public void interest_rate() throws InterruptedException, IOException {
		// Locating the interest rate element
		...
		// Entering Interest rate from properties file
	...
	public void storeDataInExcel() throws InterruptedException, IOException {
		...
		// Loop through each table and its rows to extract data
		for (int tableIndex = 0; tableIndex < tables.size(); tableIndex++) {
			...
			for (WebElement row : rows) {
				...
				// Loop through each cell and add its text to the Excel sheet
